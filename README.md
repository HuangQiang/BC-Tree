...
This repository provides the implementations and experiments of our work entitled Lightweight-Yet-Efficient: Revitalizing Ball-Tree for Point-to-Hyperplane Nearest Neighbor Search that has been published in [IEEE ICDE 2023](https://ieeexplore.ieee.org/document/10184516). You could also find our arXiv version [here](https://arxiv.org/abs/2302.10626). We implement **Ball-Tree** and **BC-Tree** for performing P2HNNS in high-dimensional spaces. To make a systematic comparison, we include two state-of-the-art hyperplane hashing schemes **NH** and **FH** (published in [SIGMOD 2021](https://dl.acm.org/doi/abs/10.1145/3448016.3457240)) as baselines for evaluations, where their implementation codes can be found [here](https://github.com/HuangQiang/P2HNNS).
